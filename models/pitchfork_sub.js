...
function Pitchfork_SubCritical_Model(){
...
Pitchfork_SubCritical_Model.prototype.parse = function(){
...
Pitchfork_SubCritical_Model.prototype.renderEquation = function(){
...
Pitchfork_SubCritical_Model.prototype.findAllRoots = function(){
...
Pitchfork_SubCritical_Model.prototype.evaluate = function(){
  this.phasePlot();
  this.findRoots();
  this.trajectory();
}
...
Pitchfork_SubCritical_Model.prototype.phasePlot = function(){
  var x = this.x;
  var r = this.r.value;
...
Pitchfork_SubCritical_Model.prototype.findRoots = function(){
  // var r = this.r.value;
...
Pitchfork_SubCritical_Model.prototype.trajectory = function(){
  this.x_list = []; this.t_list = [];
  this.rungeKuttaMethod();
}

Pitchfork_SubCritical_Model.prototype.rungeKuttaMethod = function(){
  var h = this.h;
...
Pitchfork_SubCritical_Model.prototype.createSliders = function(){
...
Pitchfork_SubCritical_Model.prototype.updateSliders = function(){
...
Pitchfork_SubCritical_Model.prototype.createGraph = function(){
...
Pitchfork_SubCritical_Model.prototype.updateGraph = function(){
